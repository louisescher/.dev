...
image: "../assets/posts/how-to-test-your-astro-site/og.png"
createdAt: 2025-04-01
draft: false
tags:
  - fun
atUri: "at://did:plc:w64dlsa4zwjv2wljlvmymldc/site.standard.document/3mn7guoduo224"
---

> ### This is an April fools article!
> If you are looking for actual resources on how to test your site, check out [the official Astro docs](https://docs.astro.build/en/guides/testing/). Having said that, feel free to still give this post a read :D
...
![A screenshot from a Nintendo 3DS system showing the website louisescher.dev unable to be loaded.](../assets/posts/how-to-test-your-astro-site/3ds-screenshot.png)
